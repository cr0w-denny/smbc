...
describe('TemplateMockGenerator', () => {
  ...
  describe('operation context building', () => {
    it('should identify list operations correctly', () => {
      ...
      const listOp = context.operations.find(op => op.path === '/users' && op.method === 'get');
    ...
    it('should identify single operations correctly', () => {
      const context = generator['buildTemplateContext']();
      const singleOp = context.operations.find(op => op.path === '/users/{id}' && op.method === 'get');
    ...
    it('should identify create operations correctly', () => {
      const context = generator['buildTemplateContext']();
      const createOp = context.operations.find(op => op.path === '/users' && op.method === 'post');
    ...
    it('should identify update operations correctly', () => {
      const context = generator['buildTemplateContext']();
      const updateOp = context.operations.find(op => op.path === '/users/{id}' && op.method === 'patch');
    ...
    it('should identify delete operations correctly', () => {
      const context = generator['buildTemplateContext']();
      const deleteOp = context.operations.find(op => op.path === '/users/{id}' && op.method === 'delete');
  ...
  describe('x-mock extensions', () => {
    ...
    it('should handle x-mock-response discrimination', () => {
      ...
      const discriminatorGenerator = new TemplateMockGenerator(specWithDiscriminator);
      ...
      expect(listOp?.discriminator?.when).toEqual({ 'summary': 'UserSummary', 'detailed': 'UserDetailed' });
    });
  });
