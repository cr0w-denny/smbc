 ...
 */
export function extractFromOperationType(operationType: any): FilterFieldConfig[] {
 ...
 */
export function parameterToFieldConfig(param: OpenAPIParameter): FilterFieldConfig {
