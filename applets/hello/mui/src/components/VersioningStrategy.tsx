    ...
    <Box sx={{ mt: 1 }}>
      <Alert severity="info" sx={{ mb: 4 }}>
        <Typography variant="body1">
          Semantic versioning strategy and publishing workflow for applets.
        </Typography>
      </Alert>
      ...
      <Grid container spacing={3} sx={{ mb: 4 }}>
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent sx={{ textAlign: "center", p: 3 }}>
              <Typography variant="h1" sx={{ fontSize: "3rem", mb: 2, color: "success.main" }}>
                🔧
              </Typography>
              ...
              <Typography variant="body2">
                Bug fixes and minor updates that don't break existing functionality.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent sx={{ textAlign: "center", p: 3 }}>
              <Typography variant="h1" sx={{ fontSize: "3rem", mb: 2, color: "warning.main" }}>
                ✨
              </Typography>
              <Typography variant="h5" sx={{ mb: 2, fontWeight: "bold" }}>
                MINOR
        ...
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent sx={{ textAlign: "center", p: 3 }}>
              <Typography variant="h1" sx={{ fontSize: "3rem", mb: 2, color: "error.main" }}>
                💥
              </Typography>
              <Typography variant="h5" sx={{ mb: 2, fontWeight: "bold" }}>
                MAJOR
              ...
              <Typography variant="body2">
                Breaking changes that require host applications to update their integration.
              </Typography>
            </CardContent>
          </Card>
        </Grid>
      ...
      <Card sx={{ mb: 3 }}>
        <CardContent>
          ...
          <Typography variant="body2" sx={{ mb: 2 }}>
            We use Changesets to manage versioning and releases across the monorepo.
          </Typography>
